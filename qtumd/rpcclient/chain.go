...
func (c *Client) GetBestBlockHashAsync() FutureGetBestBlockHashResult {
	cmd := qtumjson.NewGetBestBlockHashCmd()
...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := qtumjson.NewGetBlockCmd(hash, qtumjson.Bool(false), nil)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockVerboseResult) Receive() (*qtumjson.GetBlockVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var blockResult qtumjson.GetBlockVerboseResult
...
func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := qtumjson.NewGetBlockCmd(hash, qtumjson.Bool(true), nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockVerbose(blockHash *chainhash.Hash) (*qtumjson.GetBlockVerboseResult, error) {
...
func (c *Client) GetBlockVerboseTxAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := qtumjson.NewGetBlockCmd(hash, qtumjson.Bool(true), qtumjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// See GetBlock to retrieve a raw block instead.
func (c *Client) GetBlockVerboseTx(blockHash *chainhash.Hash) (*qtumjson.GetBlockVerboseResult, error) {
...
func (c *Client) GetBlockCountAsync() FutureGetBlockCountResult {
	cmd := qtumjson.NewGetBlockCountCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetDifficultyAsync() FutureGetDifficultyResult {
	cmd := qtumjson.NewGetDifficultyCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockChainInfoResult) Receive() (*qtumjson.GetBlockChainInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var chainInfo qtumjson.GetBlockChainInfoResult
...
func (c *Client) GetBlockChainInfoAsync() FutureGetBlockChainInfoResult {
	cmd := qtumjson.NewGetBlockChainInfoCmd()
	return c.sendCmd(cmd)
}
...
// of the main chain.
func (c *Client) GetBlockChainInfo() (*qtumjson.GetBlockChainInfoResult, error) {
...
func (c *Client) GetBlockHashAsync(blockHeight int64) FutureGetBlockHashResult {
	cmd := qtumjson.NewGetBlockHashCmd(blockHeight)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderResult {
	...
	cmd := qtumjson.NewGetBlockHeaderCmd(hash, qtumjson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockHeaderVerboseResult) Receive() (*qtumjson.GetBlockHeaderVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a string.
	var bh qtumjson.GetBlockHeaderVerboseResult
...
func (c *Client) GetBlockHeaderVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderVerboseResult {
	...
	cmd := qtumjson.NewGetBlockHeaderCmd(hash, qtumjson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderVerbose(blockHash *chainhash.Hash) (*qtumjson.GetBlockHeaderVerboseResult, error) {
...
// its hash.
func (r FutureGetMempoolEntryResult) Receive() (*qtumjson.GetMempoolEntryResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var mempoolEntryResult qtumjson.GetMempoolEntryResult
...
func (c *Client) GetMempoolEntryAsync(txHash string) FutureGetMempoolEntryResult {
	cmd := qtumjson.NewGetMempoolEntryCmd(txHash)
	return c.sendCmd(cmd)
}

// GetMempoolEntry returns a data structure with information about the
// transaction in the memory pool given its hash.
func (c *Client) GetMempoolEntry(txHash string) (*qtumjson.GetMempoolEntryResult, error) {
...
func (c *Client) GetRawMempoolAsync() FutureGetRawMempoolResult {
	cmd := qtumjson.NewGetRawMempoolCmd(qtumjson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetRawMempoolVerboseResult) Receive() (map[string]qtumjson.GetRawMempoolVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// results.
	var mempoolItems map[string]qtumjson.GetRawMempoolVerboseResult
...
func (c *Client) GetRawMempoolVerboseAsync() FutureGetRawMempoolVerboseResult {
	cmd := qtumjson.NewGetRawMempoolCmd(qtumjson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerbose() (map[string]qtumjson.GetRawMempoolVerboseResult, error) {
...
func (c *Client) VerifyChainAsync() FutureVerifyChainResult {
	cmd := qtumjson.NewVerifyChainCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainLevelAsync(checkLevel int32) FutureVerifyChainResult {
	cmd := qtumjson.NewVerifyChainCmd(&checkLevel, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainBlocksAsync(checkLevel, numBlocks int32) FutureVerifyChainResult {
	cmd := qtumjson.NewVerifyChainCmd(&checkLevel, &numBlocks)
	return c.sendCmd(cmd)
}
...
func (r FutureGetTxOutResult) Receive() (*qtumjson.GetTxOutResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutInfo *qtumjson.GetTxOutResult
...
func (c *Client) GetTxOutAsync(txHash *chainhash.Hash, index uint32, mempool bool) FutureGetTxOutResult {
	...
	cmd := qtumjson.NewGetTxOutCmd(hash, index, &mempool)
	return c.sendCmd(cmd)
}

// GetTxOut returns the transaction output info if it's unspent and
// nil, otherwise.
func (c *Client) GetTxOut(txHash *chainhash.Hash, index uint32, mempool bool) (*qtumjson.GetTxOutResult, error) {
...
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureRescanBlocksResult) Receive() ([]qtumjson.RescannedBlock, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var rescanBlocksResult []qtumjson.RescannedBlock
...
func (c *Client) RescanBlocksAsync(blockHashes []chainhash.Hash) FutureRescanBlocksResult {
	...
	cmd := qtumjson.NewRescanBlocksCmd(strBlockHashes)
	return c.sendCmd(cmd)
}
...
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) RescanBlocks(blockHashes []chainhash.Hash) ([]qtumjson.RescannedBlock, error) {
...
func (c *Client) InvalidateBlockAsync(blockHash *chainhash.Hash) FutureInvalidateBlockResult {
	...
	cmd := qtumjson.NewInvalidateBlockCmd(hash)
	return c.sendCmd(cmd)
}
