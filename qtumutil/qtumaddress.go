...
type Address interface {
	...
	IsForNet(*chaincfg.AddrParams) bool
}
...
func DecodeAddress(addr string, defaultNet *chaincfg.AddrParams) (Address, error) {
...
// bytes.
func NewAddressPubKeyHash(pkHash []byte, net *chaincfg.AddrParams) (*AddressPubKeyHash, error) {
...
func (a *AddressPubKeyHash) IsForNet(net *chaincfg.AddrParams) bool {
...
func NewAddressScriptHash(serializedScript []byte, net *chaincfg.AddrParams) (*AddressScriptHash, error) {
...
// must be 20 bytes.
func NewAddressScriptHashFromHash(scriptHash []byte, net *chaincfg.AddrParams) (*AddressScriptHash, error) {
	return newAddressScriptHashFromHash(scriptHash, net.ScriptHashAddrID)
}
...
// with the passed bitcoin network.
func (a *AddressScriptHash) IsForNet(net *chaincfg.AddrParams) bool {
...
func NewAddressPubKey(serializedPubKey []byte, net *chaincfg.AddrParams) (*AddressPubKey, error) {
...
// with the passed bitcoin network.
func (a *AddressPubKey) IsForNet(net *chaincfg.AddrParams) bool {
...
func NewAddressWitnessPubKeyHash(witnessProg []byte, net *chaincfg.AddrParams) (*AddressWitnessPubKeyHash, error) {
...
// with the passed bitcoin network.
// Part of the Address interface.
func (a *AddressWitnessPubKeyHash) IsForNet(net *chaincfg.AddrParams) bool {
...
func NewAddressWitnessScriptHash(witnessProg []byte, net *chaincfg.AddrParams) (*AddressWitnessScriptHash, error) {
...
// with the passed bitcoin network.
// Part of the Address interface.
func (a *AddressWitnessScriptHash) IsForNet(net *chaincfg.AddrParams) bool {
	return a.hrp == net.Bech32HRPSegwit
}
